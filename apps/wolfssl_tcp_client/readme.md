...
## Development kits
The following table provides links to the documentation to the TCP/IP WolfSSL TCP Client application on SAM E5X family on both bare metal and FreeRTOS.
