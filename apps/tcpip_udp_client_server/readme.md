...
## Development kits
The following table provides links to the documentation to the TCP/IP UDP Client Server Application on SAM E5X family on both bare metal(non rtos) and FreeRTOS.
