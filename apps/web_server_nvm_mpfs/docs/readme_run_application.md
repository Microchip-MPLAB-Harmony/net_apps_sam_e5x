...
|:-------------:|:---------:|:---------:|:---------:|
|sam_e54_xpro.X | ATSAME54P20A | ATSAM E54 Xplained pro |Demonstrates the TCP/IP Web Server on a development board with ATSAME54P20A device and KSZ8091 PHY daughter board. This is a bare-metal (non-RTOS) implementation.  |
|sam_e54_xpro_freertos.X | ATSAME54P20A | ATSAM E54 Xplained pro | Demonstrates the TCP/IP Web Server on development board with ATSAME54P20A device and KSZ8091 PHY daughter board. This implementation is based on FreeRTOS. |
